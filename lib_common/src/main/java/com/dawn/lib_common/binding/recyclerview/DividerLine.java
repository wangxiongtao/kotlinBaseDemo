...
public class DividerLine extends RecyclerView.ItemDecoration {
    ...
    public DividerLine(Context context, float dividerSize, LineDrawMode mode) {
        this(context, mode);
    ...
    private void drawVertical(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int right = getDividerSize() == 0 ? left + dip2px(mContext, DEFAULT_DIVIDER_SIZE) : (int) (left + getDividerSize());
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int bottom = getDividerSize() == 0 ? top + dip2px(mContext, DEFAULT_DIVIDER_SIZE) : (int) (top + getDividerSize());
            dividerDrawable.setBounds(left, top, right, bottom);
            //画上去
            dividerDrawable.draw(c);
        }
